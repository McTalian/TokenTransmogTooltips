...
- A complete and valid PLAN OUTPUT section (generated by `@#file:plan-raid`)
...
1. Check that `ID` matches an existing file in `/.collab/raid_token_records/`
2. Verify the file contains a complete PLAN OUTPUT section
3. If missing or invalid, instruct user to run `@#file:plan-raid ID="{ID}"` first
...
5. Refer to [.collab/docs/testing-guide.md](docs/testing-guide.md) for comprehensive checklist
...
```
@#file:generate-raid-code ID="002"
```
...
- [.collab/standards.instructions.md](.collab/standards.instructions.md) - Coding conventions
- [.collab/data-model.instructions.md](.collab/data-model.instructions.md) - Data structure patterns
